            ...
            if temp_file_path is not None:
                ...
                if st.session_state.llm == "Open-AI":
                    ...
                    prompt_1 =  f'''You Are an Anti-Money Laundering Specialist, Identify the transactions \
                                ...
                                transaction statement as well as savings account statements collectively. \n
                    ...
                    prompt_1=f'''You Are an Anti-Money Laundering Specialist, carefully observe the transaction pattern from both the credit card and savings account transaction statement \
