        ...
        if st.button("Generate Insights",disabled=st.session_state.disabled):
            if temp_file_path is not None:
                ...
                if st.session_state.llm == "Open-AI":
                    ...
                    You should closely look into the credit card transaction statements as well as savings account transaction statements collectively and evaluate \
                    ...
                    give a precise answer with explanation of why you think this specific type of money laundering is happening.\n\n
                    Context: {context_1}\n\
                    Response: '''
