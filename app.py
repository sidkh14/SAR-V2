            ...
            if temp_file_path is not None:
                ...
                if st.session_state.llm == "Open-AI":
                    ...
                    prompt_1 =  f'''You Are an Anti-Money Laundering Specialist, Identify the transactions \
                                ...
                                Do not include any credit card payment (Ex- Towards ABC Credit Card payment) transaction from savings account transaction statement in your response. Also, Do not repeat the above information and provide a to the point response.\n\n
                                Context: {context_1}\n\
