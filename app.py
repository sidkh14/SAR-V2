...
if st.session_state.llm == "GPT-3.5":
    ...
    with st.spinner('Summarization ...'):
        if st.button("Summarize",disabled=st.session_state.disabled):
            ...
            memory = memory,
            verbose=True)
            st.session_state["tmp_summary_gpt"] = conversation.predict(input="Provide detailed summary of the above text in a single paragraph. Please don't include words like these: 'chat summary', 'includes information' in my final summary.")
