...
if st.session_state.llm == "GPT-3.5":
    ...
    if st.button("Summarize",disabled=st.session_state.disabled):
        ...
        prompt_1 = f'''You are a fraud analyst. Analyse the text provided to give a detailed summary by reframing the sentences to create a sequence of events as to make the summary understandable.\n\n\
            Question: {query}\n\
            Context: {summ_dict}\n\                      
